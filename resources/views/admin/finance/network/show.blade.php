...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-uppercase">Edit Owlix Network</h1>
        </div>
        <form action="{{ route('admin.network.update', $network['id']) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            {!! Form::text('name', $network['company_name'], ['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            {!! Form::date('created', $network['date_of_filing'], ['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-4 form-group">
                            <label for="until" class="text-gray-800">Berlaku Hingga</label>
                            {!! Form::date('until', $network['valid_until'], ['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
            </div>
